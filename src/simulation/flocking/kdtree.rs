...
pub fn init(mut spatial: ResMut<SpatialStructure>) {
    *spatial = SpatialStructure::new();
}
...
pub fn keep_distance_to_others(world: &mut World) {
    ...
    spatial.reset(enemy_q.iter().len());
...
impl SpatialStructure {
    ...
    pub fn reset(&mut self, capacity: usize) {
        self.tree = KdTree::with_capacity(capacity);
    }
