...
struct Cli {
    ...
    /// Whether to update the navigation grid or just precalculate it.
    /// Set to true only if benchmarking flow field generation is needed.
